...
abstract contract WithdrawableOwnableUpgradeable is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    function __WithdrawableOwnable_init() internal onlyInitializing {
        __Ownable_init();
