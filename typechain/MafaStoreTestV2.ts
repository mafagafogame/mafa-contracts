...
export interface MafaStoreTestV2Interface extends utils.Interface {
  functions: {
    ...
    "c_0x343b6811(bytes32)": FunctionFragment;
...
export interface MafaStoreTestV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MafaStoreTestV2Interface;
